...
knitr::include_graphics('docs/images/imager-display.png')
```

```{r echo=FALSE, fig.align='center', fig.cap='Example display function from package imager', out.width='60%'}
knitr::include_graphics('docs/images/imager-showimage.png')
```
...
`R` Core Team (2020). `R`: A language and environment for statistical computing. R Foundation for Statistical Computing, Vienna, Austria. ([R-project](https://www.R-project.org))
